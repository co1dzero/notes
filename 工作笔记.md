...
## ![image-20230807111537663](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111537663.png)

2![image-20230807111625553](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111625553.png)

3![image-20230807111638759](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111638759.png)

4![image-20230807111651188](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111651188.png)

5![image-20230807111827004](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111827004.png)

6![image-20230807111841883](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111841883.png)

7

![image-20230807111912017](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111912017.png)

![image-20230807111924947](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807111924947.png)

8 更新了7的代码

9![image-20230807112030279](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807112030279.png)

![image-20230807112040586](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807112040586.png)

![image-20230807112054325](C:\Users\shizeyu\AppData\Roaming\Typora\typora-user-images\image-20230807112054325.png)



## [ZNJY-4654](https://jira.enncloud.cn/browse/ZNJY-4654) 
...
> features/08-preferentialPolity
>
> ```js
> {
>     path: '/add-manufacturer-policy',
>     name: 'add-manufacturer-policy',
>     meta: {
>       title: '优惠政策',
>       headerBarShow: true,
>       leftSideShow: true,
...
>       permisId: '100102',
>       pPermisId: '100004',
>       parents: ['100102', '100192'],
>     },
>     component: () =>
>       import(/* webpackChunkName: 'manufactor' */ '@/views/member/add-activity-policy'),
>   },
> ```

```
优惠政策 01自提、 02配送、 01,02 自提和配送用逗号隔开，详情接口历史数据会默认给值【01,02】

1./open/api/factoryCenter/policy/add  优惠政策新增修改接口

入参增加 params.deliveryMode  01自提、 02配送、 01,02 自提和配送

{
    "params":{
        "policyId":"",
        "versionId":"",
        "policyName":"wwx优惠政策0809",
        "policyType":"01",
        "activityType":"01",
		"deliveryMode":"01,02",  【示例】
        "pClsList":[
        ...
        "newacyiveid":"",
        "pClsId":"",
        "startdata":"2023-08-09T09:05:15.910Z",
        "times":"2023-08-09T09:05:33.000Z",
        "startTime":"2023-08-09 17:05",
        "itemList":Array[1],
        "currencyList":Array[1],
        "appId":"B351DC5302745F7C0088EC8531CCC54D"
    }
}

2./open/api/factoryCenter/policy/detail  查看详情接口

响应增加提货方式 data.deliveryMode  01自提、 02配送、 01,02 自提和配送
```
