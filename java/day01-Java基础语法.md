...
> <font color='red'>**如果要打开文件夹可以使用`explorer 文件名`的方式**</font>
...
开发Java程序，需要三个步骤：<font color='gree'>编写程序，编译程序，运行程序</font>。
...
<font color='gree'>注意：现在最新从官网上下载的JDK安装时会自动配置javac、java命令的路径到Path环境变量中去 ，所以javac、java可以直接使用。</font>
...
![](C:\Users\shizeyu\Desktop\notes\Ajax-vue\Snipaste_2023-12-12_10-45-27.jpg)
...
​	<font color='red'>JavaSE、JavaME、JavaEE</font>

#### 1.8.1 JavaSE

​	java 语言的（标准版），用于桌面应用的开发（比如计算器），<font color='gree'>是其他两个版本的基础</font>

​	是其他两个版本的基础。

​	<font color='gree'>但其实在桌面应用的开发 c和c++更适合的</font>

#### 1.8.2 JavaME

​	Java语言的小型版，用于嵌入式消费类电子设备或者小型移动设备的开发。(<font color='gree'>当初的手机系统塞班！不过现在凉了</font>)
...
​	<font color='gree'>用于Web方向的网站开发。（主要从事后台服务器的开发）</font>

​	<font color='gree'>在服务器领域，Java是当之无愧的龙头老大。</font>

众神之父：

![](C:\Users\shizeyu\Desktop\notes\Ajax-vue\Snipaste_2023-12-12_14-41-23.jpg)

### 1.9 Java的主要特性

- 面向对象

![](C:\Users\shizeyu\Desktop\notes\Ajax-vue\Snipaste_2023-12-12_14-46-20.jpg)

- 安全性
- 多线程

![](C:\Users\shizeyu\Desktop\notes\Ajax-vue\Snipaste_2023-12-12_14-47-06.jpg)

- 简单易用
- 开源
- 跨平台

![](C:\Users\shizeyu\Desktop\notes\Ajax-vue\Snipaste_2023-12-12_14-52-13.jpg)

#### 1.9.1 Java语言跨平台的原理

- <font color='gree'>操作系统本身其实是不认识Java语言的。</font>
- <font color='gree'>但是针对于不同的操作系统，Java提供了不同的虚拟机。</font>
- <font color='gree'>java语言不是直接运行在操作系统里的，而是运行在虚拟机里</font>
...
JVM（Java Virtual Machine），<font color='gree'>Java虚拟机</font>

JRE（Java Runtime Environment），<font color='gree'>Java运行环境</font>，包含了JVM和Java的<font color='gree'>核心类库</font>（Java API）

JDK（Java Development Kit）称为<font color='gree'>Java开发工具包</font>，包含了JRE和开发工具

总结：我们只需安装JDK即可，它包含了java的运行环境和虚拟机。

![](C:\Users\shizeyu\Desktop\notes\Ajax-vue\Snipaste_2023-12-12_15-24-13.jpg)
